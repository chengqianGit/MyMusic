...
public class Consts {
    ...
    public static final String ACTION_PLAY = "com.mymusic.android.ACTION_PLAY";
    public static final String ACTION_PREVIOUS = "com.mymusic.android.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.mymusic.android.ACTION_NEXT";
    public static final String ACTION_LIKE = "com.mymusic.android.ACTION_LIKE";
    public static final String ACTION_LYRIC = "com.mymusic.android.ACTION_LYRIC";
    public static final String ACTION_UNLOCK_LYRIC = "com.mymusic.android.ACTION_UNLOCK_LYRIC";
    ...
    public static final String AK = "6110ce399ee119af";
    public static final String AS = "a94f89a1feab25da";
