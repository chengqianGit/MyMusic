...
import com.mymusic.android.activity.TopicDetailActivity;
import com.mymusic.android.activity.UserDetailActivity;
import com.mymusic.android.domain.Comment;
import com.mymusic.android.listener.OnTagClickListener;
...
public class CommentAdapter extends BaseRecyclerViewAdapter<Object,CommentAdapter.BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (TYPE_TITLE==viewType) {
            return  new TitleViewHolder(getInflater().inflate(R.layout.item_comment_title, parent, false));
        }
