...
public class MeAdapter extends BaseExpandableListAdapter {
    ...
    public com.mymusic.android.domain.List getChildData(int position, int childPosition) {
        return (com.mymusic.android.domain.List) datas.get(position).getList().get(childPosition);
    }
    ...
    class ChildViewHolder{
        ...
        public void setData(com.mymusic.android.domain.List data) {
